...
pub use framework::FrameworkInstance;
...
pub struct GameFrameworkInstance {
...
impl FrameworkInstance for GameFrameworkInstance {
    ...
    fn init(
        ...
        //move this somewhere else ?  Maybe a better way to define shader files ? 
